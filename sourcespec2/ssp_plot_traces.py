...
def _savefig(figures, suffix, fig_stations=None, force_numbering=False):
    """
    Save figures to file.

    :param figures: Figures to save.
    :type figures: list of :class:`matplotlib.figure.Figure`
    :param suffix: Suffix to append to the base file name.
    :type suffix: str
    :param fig_stations: Stations per figure (for HTML search).
    :type fig_stations: list of list of str
...
def plot_traces(st, ncols=None, block=True, suffix=None):
    ...
    if config.plot_save:
        _savefig(figures, suffix, fig_stations=fig_stations)
